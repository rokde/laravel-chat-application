...
<template>
    <nav class="grid gap-6 text-lg font-medium">
        <Link
            href="#"
            class="group flex h-10 w-10 shrink-0 items-center justify-center gap-2 rounded-full dark:bg-primary text-lg font-semibold text-primary-foreground md:text-base"
        >
